						...
						<div class="col-md-4">
							<div class="card">
								<div class="card-body">
									...
									<a href="/editinternship?id=${internship.id}"
										class="btn btn-primary w-100">Edit</a><br />
									<%-- <a href="/deleteinternship?id=${internship.id}" class="btn btn-primary w-100">Delete</a> --%>
									<button onclick="(() => alert('Cannot Delete'))()"
